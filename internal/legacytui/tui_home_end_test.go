...
// Home and End are line-editing keys first. cli.RouteFocusKey used to consume them
...
// a bonus, not the only path: GNOME cli.Terminal/VTE and Konsole bind shift+home
