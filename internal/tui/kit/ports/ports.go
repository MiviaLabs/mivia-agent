...
// the harness. The adapter lives in internal/tui/kit/session (a later
...
type ToolCall struct {
	...
	// body's flag (adapter's applyEvent), and the replay paths set it
...
type TurnHandle interface {
	...
	//
	// KNOWN DIVERGENCE. The subagent transcript handles internal/tui/adapter
	...
	// SubagentThreads.Thread returned - and adapter's
...
// DROPPED under backpressure - see internal/tui/adapter's
...
// currently on screen: the consumer (internal/tui/view/screen/conversation)
