...
func TestSessionPool_LoadedSessionInheritsTools(t *testing.T) {
	...
	pool := adapter.NewSessionPool(sess1, res, nil, true)
...
func TestSessionPool_CreateFresh_InheritsToolsFlag(t *testing.T) {
	...
	pool := adapter.NewSessionPool(sess, res, nil, true)
...
func TestSessionPool_GetOrCreateWiresSubagentThreadsOnResume(t *testing.T) {
	...
	pool := adapter.NewSessionPool(initial, res, nil, false)
...
func TestSessionPool_CreateFreshWiresSubagentThreads(t *testing.T) {
	...
	if !ok || conv == nil {
		t.Fatalf("CreateFresh did not return *adapter.Conversation: %T", convPort)
	}
...
func TestSessionPool_CreateFresh_ContextStoreRoundTrips(t *testing.T) {
	...
	otherPool := adapter.NewSessionPool(other, res, nil, false)
