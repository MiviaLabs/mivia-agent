...
import (
	...
	settingsscreen "github.com/MiviaLabs/mivia-agent/internal/tui/view/screen/settings"
	"github.com/MiviaLabs/mivia-agent/internal/tui/view/screen/themepicker"
...
func TestQueueClearCommand_EmptiesQueue(t *testing.T) {
	s := newScreen(t, replay.New(nil, 0), nil, nil)
	s.queue = []string{"item1", "item2"}
...
// stopped one layer down, in internal/tui/adapter.
...
func (f *fakeCustomConversation) ActiveTurn() (ports.TurnHandle, bool) { return nil, false }
