...
// states (internal/tui/view/screen/conversation/session.go copies it in both
...
func pairedDiff(t *testing.T, pairs int) *uievent.Diff {
	...
	return &uievent.Diff{
		Path: "internal/tui/view/component/approval/approval.go", Added: pairs, Removed: pairs,
