...
// whose Capability.Timeout is LARGER than the configured registry
// default keeps its own declared budget - the outermost registered
// wrapper must publish the profile or the tighter registry default
// would kill it (the dispatch_tasks-at-10-minutes bug class).
