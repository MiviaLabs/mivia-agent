...
// command. It calls ResumeInterruptedRun on the coordinator and registers
// the resumed handle with the resuming caller's principal.
//
...
// before re-spending budget on a resume.
