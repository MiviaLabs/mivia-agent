...
func newSchemaDispatchTool(t *testing.T, replies []string, cfg config.SubagentConfig) (*orchestrate.DispatchTasksToolForTest, *runtime.Dispatcher) {
	t.Helper()
...
func dispatchWithSchema(t *testing.T, tool *orchestrate.DispatchTasksToolForTest, schema map[string]any) []map[string]any {
	t.Helper()
	args := map[string]any{
