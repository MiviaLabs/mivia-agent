...
// settled) under a non-auto merge policy, settleStackPlanRunIfComplete
...
func TestSettleStackPlanRunIfCompleteSettlesSkippedPublication(t *testing.T) {
	...
	if err := settleStackPlanRunIfComplete(context.Background(), prepared, planRunID, &stdout); err != nil {
