...
func TestSessionAutoDeliveryRepairLoopWithholdsApprovePolicyChunkPublish(t *testing.T) {
	...
	repairSettleRunToDeliveryPending(t, repo, chunkRun.RunID)
...
// repairSettleRunToDeliveryPending advances a freshly-created pending run to
...
func repairSettleRunToDeliveryPending(t *testing.T, repo workflowledger.Repository, runID string) {
	t.Helper()
	ctx := context.Background()
