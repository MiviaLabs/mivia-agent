...
func TestWaitForChunkMergesPausesWhenPublishedFollowUpRemains(t *testing.T) {
	...
	seedGitMergeDeliveryPendingRun(t, repo, workflowledger.RunSnapshot{RunID: "wfr-c1-deferred", InvocationKey: stackID + ":c1-deferred"}, []byte("snapshot"))
...
func TestWaitForChunkMergesPausesWhenOnlyGrantsRemain(t *testing.T) {
	...
	seedGitMergeDeliveryPendingRun(t, repo, workflowledger.RunSnapshot{RunID: "wfr-c1", InvocationKey: stackID + ":c1"}, []byte("snapshot"))
