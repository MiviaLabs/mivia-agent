...
// file keeps the CLI-facing interface, the sentinel alias, the drive-loop
// adapter, and the delegating checker.
...
// gitMergeCheck adapts gitMergeChecker to the value shape the drive loop's
// completion check consumes.
