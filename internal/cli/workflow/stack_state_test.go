...
func TestChunkRunNoDiff(t *testing.T) {
	...
	seedGitMergeDeliveryPendingRun(t, repo, noDiffRun, []byte("{}"))
	...
	seedGitMergeDeliveryPendingRun(t, repo, pushedRun, []byte("{}"))
...
func TestChunkRunNoDiffRequiresPositiveEvidence(t *testing.T) {
	...
	seedGitMergeDeliveryPendingRun(t, repo, noEvidenceRun, []byte("{}"))
