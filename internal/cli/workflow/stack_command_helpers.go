...
// Exported entry points; package variables so tests can stub them.
var (
	ParseStackWorkflowArgs = parseStackWorkflowArgs
	ResolveStackID         = resolveStackID
	OpenStackLedger        = openStackLedger
)
