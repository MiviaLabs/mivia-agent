...
// adapter cannot import internal/cli/worktree directly (UI isolation).
...
// This bridge keeps adapter independent from internal/cli/worktree.
...
// internal/cli/worktree directly (UI isolation).
