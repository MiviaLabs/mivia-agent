...
func TestCompile_OnPRMetadataFailureUnknownStepRejectedRegardlessOfActivity(t *testing.T) {
	for _, tc := range []struct {
		name  string
		deliv *definition.Delivery
	}{
		{"active draft", &definition.Delivery{Kind: "pull_request", Mode: "draft", Provider: "github", Base: "main"}},
		{"inactive mode none", &definition.Delivery{Kind: "pull_request", Mode: "none", Provider: "github", Base: "main"}},
		{"inactive empty kind", &definition.Delivery{Kind: ""}},
	} {
