...
// section at once.
func validateLimitsAndStacking(wf *definition.WorkflowFile, stepIDs map[string]bool) []string {
	var errs []string
...
// policies are errors.
func validateStacking(wf *definition.WorkflowFile, stepIDs map[string]bool) []string {
	if wf.Stacking == nil {
