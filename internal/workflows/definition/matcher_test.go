...
func TestMatchExactStatusAndOutput(t *testing.T) {
	transitions := []Transition{
		{From: "review", To: "verify", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
		{From: "review", To: "implement", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "changes_requested"}}, Loop: "review_repair", MaxIterations: -1},
	}
...
func TestMatchStatusOnly(t *testing.T) {
	transitions := []Transition{
		{From: "implement", To: "review", Match: MatchCriteria{Status: "succeeded"}},
	}
...
func TestMatchScalarNumberAndBool(t *testing.T) {
	transitions := []Transition{
		{From: "gate", To: "ok", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"count": "2", "ok": "false"}}},
	}
...
func TestMatchRejectsNonScalarOutputLeaf(t *testing.T) {
	transitions := []Transition{
		{From: "gate", To: "ok", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"meta": "x"}}},
	}
...
func TestMatchZeroMatchFailClosed(t *testing.T) {
	transitions := []Transition{
		{From: "review", To: "ok", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
	}
...
func TestMatchMultiMatchFailClosed(t *testing.T) {
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded"}},
		{From: "a", To: "c", Match: MatchCriteria{Status: "succeeded"}},
	}
...
func TestMatchPrefersStrictlyMostSpecific(t *testing.T) {
	...
	transitions := []Transition{
		{From: "a", To: "fallback", Match: MatchCriteria{Status: "succeeded"}},
		{From: "a", To: "specific", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
	}
...
func TestMatchPrefersStrictSuperset(t *testing.T) {
	...
	transitions := []Transition{
		{From: "a", To: "specific", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"a": "1", "b": "2"}}},
		{From: "a", To: "fallback", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"a": "1"}}},
	}
...
func TestMatchSameSpecificityTieFailsClosed(t *testing.T) {
	...
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"a": "1"}}},
		{From: "a", To: "c", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"b": "2"}}},
	}
...
func TestMatchDifferentSizeDisjointCriteriaFailsClosed(t *testing.T) {
	...
	transitions := []Transition{
		{From: "a", To: "one-key", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"a": "1"}}},
		{From: "a", To: "two-keys", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"b": "2", "c": "3"}}},
	}
...
func TestMatchIgnoresOtherFromSteps(t *testing.T) {
	transitions := []Transition{
		{From: "other", To: "x", Match: MatchCriteria{Status: "succeeded"}},
		{From: "review", To: "verify", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
	}
...
func TestMatchDigestStable(t *testing.T) {
	criteria := MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved", "z": "1"}}
	a := matchDigest(criteria)
	b := matchDigest(MatchCriteria{Status: "succeeded", Output: map[string]string{"z": "1", "verdict": "approved"}})
	if a == "" || a != b {
...
func TestDecisionCarriesPartialTarget(t *testing.T) {
	transitions := []Transition{
		{From: "review", To: "implement", Match: MatchCriteria{Status: "succeeded"}, Loop: "repair", MaxIterations: 2, PartialTarget: "deliver"},
		{From: "review", To: "success", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
	}
	d, err := Match("review", "succeeded", map[string]any{"verdict": "changes_requested"}, transitions)
	if err != nil {
		t.Fatal(err)
