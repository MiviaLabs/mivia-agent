...
func validatePanels(wf *WorkflowFile) []string {
	var errs []string
	for _, step := range wf.Steps {
		...
		if step.Panel.FailurePolicy != PanelFailurePolicyRequireAll && step.Panel.FailurePolicy != PanelFailurePolicyAllowPartial {
...
func validatePanelMembers(stepID string, members []PanelMember) []string {
	var errs []string
