...
func TestProbeDuplicateOutputCriteriaFailsClosed(t *testing.T) {
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
		{From: "a", To: "c", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
	}
...
func TestProbeNullArrayAndObjectLeavesNeverMatch(t *testing.T) {
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"k": "x"}}},
	}
