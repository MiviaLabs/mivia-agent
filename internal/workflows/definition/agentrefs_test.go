...
func agentTestWorkflow(stepID, kind, agent string) *WorkflowFile {
	return &WorkflowFile{
		Version:     1,
		...
		Transitions: []Transition{
			{From: stepID, To: "success", Match: MatchCriteria{Status: "succeeded"}},
		},
	}
}
...
func TestValidateAgentReferences_SkipsEmptyAgentField(t *testing.T) {
	...
	wf := &WorkflowFile{
		...
		Transitions: []Transition{
			{From: "first", To: "second", Match: MatchCriteria{Status: "succeeded"}},
			{From: "second", To: "success", Match: MatchCriteria{Status: "succeeded"}},
		},
	}
