...
func TestFormatWorkflowValidate_Valid(t *testing.T) {
	c := &CompiledWorkflow{Name: "feature-delivery"}
...
func newFullFixtureWorkflow() *CompiledWorkflow {
...
func fullFixtureTransitions() []Transition {
	return []Transition{
		{From: "plan", To: "plan_review", Match: MatchCriteria{Status: "succeeded"}},
		{
			From: "plan_review", To: "plan_tests",
			Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}},
		},
		{
			From: "plan_review", To: "plan",
			Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "changes_requested"}},
		...
		},
		{
			...
			Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"status": "passed"}},
		},
		{
...
func fullFixtureDelivery() *Delivery {
	return &Delivery{
		Kind:     "pull_request",
		Mode:     "draft",
		Provider: "github",
