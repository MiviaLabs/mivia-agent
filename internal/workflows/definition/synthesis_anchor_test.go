...
func TestSynthesizeStacking_MultiStepPlanPhaseAnchorsRouterAtPlanPhaseExit(t *testing.T) {
	...
	wf.Transitions = []Transition{
		{From: "plan", To: "plan_review", Match: MatchCriteria{Status: "succeeded"}},
		{From: "plan_review", To: "plan_tests", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
		{From: "plan_review", To: "plan", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "changes_requested"}}, Loop: "plan_review_repair", MaxIterations: 5},
		{From: "plan_tests", To: "test_plan_review", Match: MatchCriteria{Status: "succeeded"}},
		{From: "test_plan_review", To: "implement", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "approved"}}},
		{From: "test_plan_review", To: "plan_tests", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"verdict": "changes_requested"}}, Loop: "test_plan_review_repair", MaxIterations: 5},
...
func TestSynthesizeStacking_PlanDirectEdgeWithDistinctAnchor(t *testing.T) {
	...
	wf.Transitions = []Transition{
		...
		{From: "plan", To: "plan_review", Match: MatchCriteria{Status: "failed"}},
		{From: "plan_review", To: "implement", Match: MatchCriteria{Status: "succeeded"}},
		{From: "implement", To: "success", Match: MatchCriteria{Status: "succeeded"}},
	}
	cw, err := Compile(wf)
	if err != nil {
...
func TestSynthesizeStacking_PreservesOutputDiscriminatedShortcutEdge(t *testing.T) {
	...
	wf.Transitions = []Transition{
		{From: "plan", To: "plan_review", Match: MatchCriteria{Status: "succeeded"}},
		{From: "plan", To: "implement", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"skip_review": "true"}}},
		{From: "plan_review", To: "implement", Match: MatchCriteria{Status: "succeeded"}},
		{From: "implement", To: "success", Match: MatchCriteria{Status: "succeeded"}},
	}
	cw, err := Compile(wf)
