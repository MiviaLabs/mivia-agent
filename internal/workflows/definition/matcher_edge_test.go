	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			transitions := []Transition{
				{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": tc.want}}},
			}
...
func TestMatchNonJSONFloatsNeverMatch(t *testing.T) {
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "NaN"}}},
		{From: "a", To: "c", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "+Inf"}}},
		{From: "a", To: "d", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "-Inf"}}},
	}
...
func TestMatchAllIntegerScalarTypesMatch(t *testing.T) {
	...
	for _, tc := range values {
		t.Run(tc.name, func(t *testing.T) {
			transitions := []Transition{
				{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "3"}}},
			}
	...
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "-7"}}},
	}
...
func TestMatchFloat32UsesJSONCanonicalForm(t *testing.T) {
	transitions := []Transition{
		{From: "a", To: "b", Match: MatchCriteria{Status: "succeeded", Output: map[string]string{"n": "0.00001"}}},
	}
