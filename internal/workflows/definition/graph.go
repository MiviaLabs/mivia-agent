...
func validateGraph(wf *WorkflowFile, stepIDs map[string]bool) []string {
	var errs []string
...
func seedDeliveryTargets(wf *WorkflowFile, stepIDs map[string]bool, visited map[string]bool, queue []string) []string {
...
func validateCycles(wf *WorkflowFile) []string {
	// Build step ID set
