...
func TestCompile_DeliveryReentryStepReachable(t *testing.T) {
	wf := &WorkflowFile{
		...
		Transitions: []Transition{
			{From: "plan", To: "review", Match: MatchCriteria{Status: "succeeded"}},
			{From: "review", To: "success", Match: MatchCriteria{Status: "succeeded"}},
			{From: "repair_pr_metadata", To: "review", Match: MatchCriteria{Status: "succeeded"}},
		},
		Delivery: &Delivery{
			Kind:                "pull_request",
			Mode:                "draft",
