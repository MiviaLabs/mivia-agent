...
func (e *Engine) loadAndValidateWorkflow(req workflowagenttools.StartRequest) (*definition.CompiledWorkflow, []byte, string, map[string]any, map[string]string, error) {
