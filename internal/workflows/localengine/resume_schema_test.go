...
func startSchemaStep(t *testing.T, svc *workflowagenttools.Service) workflowagenttools.StartResult {
	t.Helper()
...
// runner does.
func startBlockedSchemaStep(t *testing.T) (*localengine.Engine, workflowledger.Repository, *workflowagenttools.Service, workflowagenttools.StartResult, chan struct{}, chan struct{}) {
	t.Helper()
