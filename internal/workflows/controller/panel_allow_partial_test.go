...
func panelAllowPartialFixture(t *testing.T, runID string, policy string, memberHandler runtime.Handler, synthesisOutput string) (*LinearController, controllerRepository) {
	t.Helper()
