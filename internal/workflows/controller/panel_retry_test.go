...
func panelRetryFixture(t *testing.T, runID string, memberHandler runtime.Handler, synthesisOutput string, limits definition.Limits) (*LinearController, LedgerRepository) {
	t.Helper()
...
func countPanelAttempts(t *testing.T, repo LedgerRepository, runID string) (failed, succeeded, total int) {
	t.Helper()
