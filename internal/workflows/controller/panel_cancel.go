...
func ReconcilePanelCancellation(ctx context.Context, repo controllerRepository, panel PanelCancelCoordinator, runID, holder, attemptID string) (workflowledger.StepAttempt, bool, error) {
...
func advancePanelPhaseToCancelPending(ctx context.Context, repo controllerRepository, runID, holder string, attempt workflowledger.StepAttempt) (workflowledger.StepAttempt, error) {
	if holder == "" {
