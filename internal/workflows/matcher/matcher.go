...
func Match(fromStep, status string, output map[string]any, transitions []definition.Transition) (Decision, error) {
...
func matchOne(status string, output map[string]any, criteria definition.MatchCriteria) (map[string]string, bool) {
...
func matchDigest(criteria definition.MatchCriteria) string {
