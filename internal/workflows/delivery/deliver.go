...
// retry.
func Deliver(ctx context.Context, repo LedgerRepository, git GitRunner, pr PRClient, req Request) (Result, error) {
...
// is the pin.
func verifyEligibilityAndStage(ctx context.Context, repo LedgerRepository, git GitRunner, req Request, key string, run ledger.RunSnapshot) (head string, porcelainEmpty bool, diffRef, repoSlug, originBase string, noDiff bool, err error) {
...
func deliveryRunGuard(ctx context.Context, repo LedgerRepository, req Request) (ledger.RunSnapshot, error) {
...
// error.
func promoteToDeliveryPending(ctx context.Context, repo LedgerRepository, runID string, run ledger.RunSnapshot) (ledger.RunSnapshot, error) {
...
func verifyEligibility(ctx context.Context, repo LedgerRepository, git GitRunner, req Request, key, originBase string) (head string, porcelainEmpty bool, diffRef, repoSlug string, err error) {
...
func pushAndPublish(ctx context.Context, repo LedgerRepository, git GitRunner, pr PRClient, req Request, key, repoSlug, head, treeSHA, diffRef, originBase string, existing ledger.DeliveryRecord, title, body string) (Result, error) {
...
func findOrCreatePR(ctx context.Context, repo LedgerRepository, pr PRClient, req Request, key, repoSlug string, existing ledger.DeliveryRecord, title, body string) (*PRRef, error) {
