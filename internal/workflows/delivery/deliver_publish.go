...
// ERASES it.
func pushDeliveryBranch(ctx context.Context, repo deliveryRepository, git GitRunner, req Request, key, head, treeSHA, diffRef string, existing ledger.DeliveryRecord) error {
...
func findOrCreateAndVerifyPR(ctx context.Context, repo deliveryRepository, git GitRunner, pr PRClient, req Request, key, repoSlug, originBase string, existing ledger.DeliveryRecord, title, body string) (string, string, error) {
