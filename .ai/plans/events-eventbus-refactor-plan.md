...
<task>
You are implementing the event bus and UI refresh architecture plan at `.ai/events-eventbus-refactor-plan.md`.
...
7. **Write `.ai/phase1-complete.md`** summarizing changes, test coverage, and any deviations.
