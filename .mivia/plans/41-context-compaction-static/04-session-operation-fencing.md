...
|---|---|---|---|---|
| 04-RED-001 | 1 | RED | `internal/chat/clear_race_test.go` | `TestLoadCannotResurrectAfterClear`; depends 03-REVIEW-003; `go test -run '^TestLoadCannotResurrectAfterClear$' ./internal/chat`; 120s; `internal/chat/clear_race_test.go`, `internal/chat/persistence.go`, `internal/chat/session.go`, `internal/contextstate/contracts.go` |
